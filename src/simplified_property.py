...
pub_dict = {}
msg_dict = { 'mavros/local_position/pose' : "geometry_msgs/PoseStamped"}
def monitor():
	global pub_error, pub_verdict
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('simplified_property', anonymous=True)
	pub_error = rospy.Publisher(name = 'simplified_property/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'simplified_property/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/robotlab/code/ros/px4_ws/src/rosmondemo/ROSMonitoringConfigs/simplified_property.txt' 
	actions = {
